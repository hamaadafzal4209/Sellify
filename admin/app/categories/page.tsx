...
import { createCategory, deleteCategory, fetchAllCategories, updateCategory } from "../redux/Features/category/categoryAction";
...
export default function CategoriesPage() {
  ...
  const handleUpdateCategory = () => {
    ...
    const reader = new FileReader();
    reader.onloadend = () => {
      dispatch(updateCategory(currentCategory._id, newCategoryName, reader.result));
    ...
    <div className="max-w-3xl w-full mx-auto p-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <Dialog>
          ...
          <DialogContent>
            ...
            />
            <DialogFooter>
              <Button onClick={handleCreateCategory} disabled={loading} className="bg-blue-600 text-white hover:bg-blue-700">
              ...
              .map((category) => (
                <TableRow key={category._id} className="hover:bg-gray-100">
                  ...
                  <TableCell className="py-2">
                    <Image src={category.image[0].public_url} alt={category.name} width={50} height={50} className="rounded" />
                  </TableCell>
                  <TableCell className="py-2">
                    <Button
                      variant="outline"
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent>
          ...
          />
          <DialogFooter>
            <Button onClick={handleUpdateCategory} disabled={loading} className="bg-blue-600 text-white hover:bg-blue-700">
